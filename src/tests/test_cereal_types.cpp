...
TEST_CASE("cereal_types: Level round-trip preserves display layer", "[cereal_types][display-layer]") {
  Common common;
  Level src(common);
  src.width = 4;
  src.height = 3;
...
TEST_CASE("cereal_types: Level round-trip preserves anim layer",
